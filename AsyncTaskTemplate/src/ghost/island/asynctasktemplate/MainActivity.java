...
public class MainActivity extends ActionBarActivity implements AsyncTaskListener {
    ...
    public static class PlaceholderFragment extends Fragment {
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container,
            ...
            new AsyncTaskTemplate(getActivity()).execute();
            return rootView;
        }
    }
    ...
    public <T> void onTaskComplete(T result) {
        ...
        fragment.message.setText((String) result);
    }

    @Override
    public <T> void onTaskUpdate(T progress) {
        PlaceholderFragment fragment = (PlaceholderFragment)getSupportFragmentManager().findFragmentById(R.id.container);
        fragment.message.setText(String.valueOf(progress) + " second");
    }
}
